...
class MenuController extends Controller {
  ...
  private function updateRoleMenu($idMenu,$crud){
    $res = [];
  ...
  private function addRolesToResult(&$menus){
    if (!$menus) return;
    $roles = CmsMenuRoles::getByIdsMenuGrouped(array_map(function($m){return $m["id"];},$menus));
